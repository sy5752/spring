...
public class IocTest {
	...
	public void beanScopeTest() {
		...
		// 디자인 패턴의 singleton개념으로 보면 두개의 객체는 한 클래스로부터 나왔으므로 동일해야함
		// 하지만 스프링의 singleton개념은 bean 엘레멘트를 기준으로 하나의 객체가 생성된다
	...
	public void beanScopePrototypeTest2() {
		...
		// 동일한 userServicePrototype 스프링 빈을 주입(scope : prototype)
